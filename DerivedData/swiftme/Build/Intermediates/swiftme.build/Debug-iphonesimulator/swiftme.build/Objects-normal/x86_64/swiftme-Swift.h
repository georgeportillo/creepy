...
SWIFT_CLASS("_TtC7swiftme11AppDelegate")
...
SWIFT_CLASS("_TtC7swiftme15MyTableViewCell")
...
@property (nonatomic, readonly) CGFloat OffsetSpeed;
- (void)awakeFromNib;
...
SWIFT_CLASS("_TtC7swiftme23PartTableViewController")
...
SWIFT_CLASS("_TtC7swiftme24SinglePartViewController")
@interface SinglePartViewController : UIViewController <FBSDKLoginButtonDelegate>
@property (nonatomic, weak) IBOutlet GADBannerView * __null_unspecified bannerView;
@property (nonatomic, weak) IBOutlet UITextView * __null_unspecified singlePartTextView;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC7swiftme14ViewController")
@interface ViewController : UIViewController <UIScrollViewDelegate, UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, readonly) CGFloat ImageHeight;
@property (nonatomic, readonly) CGFloat OffsetSpeed;
@property (nonatomic, weak) IBOutlet UITableView * __null_unspecified storyTableView;
@property (nonatomic, weak) IBOutlet GADBannerView * __null_unspecified bannerView;
- (void)viewDidLoad;
- (void)didReceiveMemoryWarning;
